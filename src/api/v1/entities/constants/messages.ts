...
export const messageObj: { [key: number]: Message; } = {
    ...
    // User
    1100: { message: 'User already exists', status: MessageStatus.failure },
    1101: { message: 'No user found', status: MessageStatus.failure },

    // User
    1150: { message: 'Branch with same name already exists', status: MessageStatus.failure },
    1151: { message: 'Branch created successfully', status: MessageStatus.success },
    1152: { message: 'Branch creation Failed', status: MessageStatus.failure },

    // Ticket
    1200: { message: 'Invalid ticket', status: MessageStatus.failure },
    1201: { message: 'Ticket closed successfully', status: MessageStatus.failure },
};
